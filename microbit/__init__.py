...
class Image:
    ...
    def get_pixel(self, x: int, y: int) -> int:
        """Return the brightness of set_pixel at column ``x`` and row ``y`` as an
    ...
    def crop(self, x: int, y: int, w: int, h: int) -> Image:
        ...
        height of ``h``, starting with the set_pixel at column ``x`` and row
        ``y``.
        """
    ...
    def __add__(self, other: Image) -> Image:
        ...
        images for each set_pixel.
        """

    def __mul__(self, n: float) -> Image:
        """Create a new image by multiplying the brightness of each set_pixel by
        ``n``.
        """
